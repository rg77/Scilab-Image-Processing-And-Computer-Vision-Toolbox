...
// points : It is a MX4 matrix. It returns the points of intersection of the line with the image border. 
//	    Each row is of the form [x1,y1,x2,y2] where (x1,y1) and (x2,y2) are the two points of intersection. 
//   	    If a given line does not intersect the image border, the function returns [-1 -1 -1 -1].
//
// Description 
